...
const Product = (props) => {
    return (
        ...
        <div className="product w-[350px] overflow-hidden rounded-lg border-[1px] my-5 transition duration-300 ease-in-out transform hover:shadow-lg hover:scale-105">
