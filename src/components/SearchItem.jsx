...
const SearchItem = ({name, price, productId}) => {
    ...
    return (
        <div className="item bg-gray-100 border-y-2 w-full flex justify-between items-center verySmMobile:p-[1rem] tablet:p-[2rem] cursor-pointer" onClick={()=>{window.location.replace(`/product/${productId}`)}}>
